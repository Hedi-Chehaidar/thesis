...
Figure~\ref{cf_dict} shows the effect of the contributions on the Dict FSST compression. The filtering of the dataset resulted in a moderate CF improvement from the original Dict FSST algorithm, showing a 6.3\% higher average compression ratio than FSST.
