...
% Mihail: Should we put them as strings?
...
% Mihail: Please use \log(n), do not be italicized. Also below.
...
\noindent
\newline
% Mihail: I think in Latex, we should use ``fs'' instead of "fs". Up to you.
